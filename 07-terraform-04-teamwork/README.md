...
[^1]: atlantis - сыроватый продукт, более-менее нормально работающий только с дефолтными настройками. Поведение зависит от используемого раннера. 400+ открытых issues, из них 90+ багов. Половина из них решена, но не закрыта...
