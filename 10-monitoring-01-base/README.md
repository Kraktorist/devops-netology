...
- Можно предложить построить ELK/EFK стэк с ограниченной схемой сбора логов. Например,
  ...
  Эта схема позволит отлавливать часть ошибок, в особенности "ожидаемых", а также позволит масштабировать схему до полноценной, когда на это будут выделены ресурсы.
